...
class SurveyFourViewController: UIViewController {
    ...
    func navigateToNext(){ //navigate without navigation controll
        ...
        let mianStorybord = UIStoryboard(name:"Main", bundle: Bundle.main)
         guard let surveyTwoVC = mianStorybord.instantiateViewController(withIdentifier: "SurveyCompletionViewController") as?
             SurveyCompletionViewController else{
                 return
         }
